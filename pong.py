...
ball.penup()
ball.goto(0, 0)
ball.horizontal_speed = 0.3
ball.vertical_speed = -0.3
...
while True:
    ...
    #move the ball
    ball.setx(ball.xcor() + ball.horizontal_speed)
    ball.sety(ball.ycor() + ball.vertical_speed)

    #border checking
    
    if ball.ycor() > 290:
        ball.sety(290)
        ball.vertical_speed *= -1  #reverse the direction
